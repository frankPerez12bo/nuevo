                    ...
                    <tbody>
                        <?php foreach ($provedores as $provedor){?>
                            <tr class="">
                                ...
                                <td><?php echo "Cantidad en Inventario : ".$provedor['cantidad_inventario']."<br>"."Ingreso a Inventario : ".$provedor['cant_total_ingreso']."/unid"."<br>"."Total Ingreso Productos: ".$provedor['cant_ingreso_inven']; ?></td>
                                <td><?php echo "Total Vendido: ".$provedor['cantidad_comprar']."/unid"."<br>"; ?></td>
