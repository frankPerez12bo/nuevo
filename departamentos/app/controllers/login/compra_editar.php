        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data" id="miFormularioTwo">
                    ...
                    <span id="message"></span> <!-- Elemento para mostrar mensajes de error o información -->
                    <div class="mb-3">
                    ...
                    <div class="fluid" id="card-<?php echo $precio_unid_venta;?>">
                        <div class="mb-3">
                            <label for="precio_cal" class="form-label">Precio:</label>
                            <input
                                type="text"
                                class="form-control"
                                readonly
...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    function validatePayment(e) {
        ...
        if (payment < total) {
            message.textContent = "Cantidad insuficiente";
...
<script>
    let miFormularioTwo = document.getElementById('miFormularioTwo').addEventListener('submit',(e)=>{
        let efectivo_pagar = document.getElementById('efectivo_pagar').value.trim();
        let total = document.getElementById('total').value.trim();
        let message = document.getElementById('message');

        if(efectivo_pagar < total) {
            message.textContent = "Cantidad insuficiente ingrese una cantidad que supere o sea igual a $"+total;
            e.preventDefault();
        }
    });
</script>