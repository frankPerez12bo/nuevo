<?php include('../../../config/config.php');
    if($_POST){
        ...
        $fecha_correo = $_POST['fecha_correo'];
        $sql = "INSERT INTO tbl_login_usuario(id,
                                                nombre_usuario,
                                                correo_usuario,
                                                clave_usuario,
                                                pais_usuario,
        ...
        $sentencia->bindParam(':fecha_correo',$fecha_correo);
...
<section class="fluid text-center border border-2 border-warning text-primary py-4">
    <h4 style="letter-spacing:.9vw">Crear Cuenta</h4>
</section>
<hr>
                ...
                <form id="formulario" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="correo_usuario"
                            oninput="valida_correo()"
                            id="correo_usuario"
                            aria-describedby="helpId"
                            placeholder="Correo :"
                        />
                    </div>
                    <span class="span_correo" id="spanCorreo">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pais_usuario" id="pais_usuario" class="form-control">
...
<script>
    ...
    formulario.addEventListener('submit', function(e) {
        ...
        let pais_usuario =  document.getElementById('pais_usuario').value.trim();
        let telefono_usuario = document.getElementById('telefono_usuario').value.trim();
   // let fecha_correo = document.getElementById('fecha_correo').value.trim();
        if (nombre_usuario == '' ||
            correo_usuario == '' ||
            clave_usuario == '' ||
            pais_usuario  == '' ||
...
<script src="validarNombre.js" ></script>
<script src="valida_correo.js"></script>