...
<section class="row border border-4 border-dark py-5" style="gap:02vw;padding-left: 05vw;"id="librosMain">
    ...
    <?php foreach ($clientes as $cliente){?>
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 card text-start" style="gap: 01vw;">
            <img class="card-img-top" src="https://images.playground.com/c09d044731964c0b99ef4302b98868ca.jpeg" alt="Title" style="clip-path: polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%);" width="50px" height="170px" />
            <div class="card-body">
