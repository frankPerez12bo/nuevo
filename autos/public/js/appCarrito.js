    ...
    productos.forEach(producto => {
        ...
        <div id="main" style="display: grid;grid-template-columns:1fr 1fr 1fr;">
            <div class="border border-3 border-dark bg-white" id="containerMain">
                ...
                <span><p id="cantidad" class="bg-dark text-white py-1" style="font-weight: bold;">Cantidad: <strong> ${producto.cantidad} </strong> </p></span>
                <span><p id="precio" class="bg-dark text-white py-1 text-center" style="font-weight: bold;">Precio: <strong> ${producto.precio} </strong> </p></span>
